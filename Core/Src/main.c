...
static void startDaTimer(){
	/* USER CODE BEGIN TIM1_Init 0 */
	  ...
	  */
	  ...
	  __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, 5000 * 2); // 1ms
	  HAL_Delay(2000);
	__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, 5000 * 1); // 1ms
		while(1){
			1+1;
		}
